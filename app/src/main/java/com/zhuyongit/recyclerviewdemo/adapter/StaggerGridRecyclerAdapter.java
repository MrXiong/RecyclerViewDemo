 ...
 * @version 1.0
 */
public class StaggerGridRecyclerAdapter extends RecyclerView.Adapter{
    ...
    public StaggerGridRecyclerAdapter(List<NewsBean> datas) {
        this.mDatas = datas;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // 返回单个Item的View对象
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_recycler_item_layout,parent,false) ;
