 ...
 * @version 1.0
 *
 * RecyclerView 下拉刷新列表数据适配器
 */
public class SwipeRefreshRecyclerAdapter extends RecyclerView.Adapter{

    private static final String TAG = "SwipeRefreshRecyclerAdapter" ;

    private List<NewsBean> mDatas ;

    private OnLongClickListener     mOnLongClickListener ;

    public SwipeRefreshRecyclerAdapter(List<NewsBean> datas) {
        this.mDatas = datas;
    }
     ...
     * @param newsBeans
     */
    public void refreshAllData(List<NewsBean> newsBeans) {
        mDatas.clear();
        if (mDatas.isEmpty()) {
